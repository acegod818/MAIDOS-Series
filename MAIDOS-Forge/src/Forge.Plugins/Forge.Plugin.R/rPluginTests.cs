...
public class rPluginTests
{
    ...
    {
        var plugin = new Forge.Plugin.r.rPlugin();
        var caps = plugin.GetCapabilities();

        Assert.Equal("r", caps.LanguageName);
        Assert.True(caps.SupportedExtensions.Contains(".r"));
    }
    ...
    public void Test_GenerateGlue_CSharp()
    {
        ...
        var iface = new Forge.Core.Plugin.InterfaceDescription
        {
            ...
            Language = new Forge.Core.Plugin.InterfaceLanguage { Name = "r", Abi = "c" },

...
export const REDLINES: Redline[] = [
  ...
  { id: 'R04', category: 'redline', name: '未授權數據訪問', nameEn: 'Unauthorized Data Access', description: '訪問超出權限的數據', severity: 'error', action: '🔴 撤銷，審查', autoDetectable: true, detectMethod: 'regex+heuristic', implemented: true },
  ...
  { id: 'R06', category: 'redline', name: '直接操作生產', nameEn: 'Direct Production Access', description: '未經審批修改生產環境', severity: 'error', action: '🔴 回滾', autoDetectable: true, detectMethod: 'regex+heuristic', implemented: true },
  ...
  { id: 'R11', category: 'redline', name: '跳過代碼審查', nameEn: 'Skip Code Review', description: '未審查代碼進入主分支', severity: 'error', action: '🔴 回滾，補審查', autoDetectable: true, detectMethod: 'regex+heuristic', implemented: true },
